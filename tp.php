...
if(isset($_POST['add']))
 ...
 /* else 
  {
   ...
   else
   {
      ...
      {
        $contactErr= "<br> Only numbers of length 10 are allowed <br>";
      }
   }
 ...
 //  $genderErr = $websiteErr  = $addressErr = $s_stdErr = "";
...
if($row_count2==1)
{
     ...
     echo " Data can't be inserted as User Already Exists";
}
else
{
      $rollno=$_POST['rno'];
        ...
        $query = " INSERT INTO Student2(rollno,name,email,dob, Address, contact, Standard) VALUES ('$rollno','$name','$email','$dob','$address','$contact','$standard') ";
...
?>
 ...
 <body>
          <form action="tp.php" method="post" name="student_info" enctype="multipart/form-data">
